  ...
  return (
    ...
    <div className='flex flex-col gap-6 py-10'>
      <Swiper/>
        ...
        <h2 className='text-3xl font-semibold'>Google to boost android security in few days</h2>
        ...
        <div>
          <img className='w-[67vw] h-[40vw] object-cover' src="https://images.pexels.com/photos/12987876/pexels-photo-12987876.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
        </div>
        <div>
