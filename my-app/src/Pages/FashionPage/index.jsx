...
const FashionPage = () => {
  return (
    <div className='flex flex-col gap-6 py-10'>
      ...
      <h2 className='text-3xl font-semibold'>No escaping new high tech speed cameras</h2>
      ...
      <div>
        <img className='w-[67vw] h-[40vw] object-cover' src="https://images.pexels.com/photos/1798665/pexels-photo-1798665.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
      </div>
      <div>
