...
const TechnologyPage = () => {
  return (
    <div className='flex flex-col gap-6 py-10'>
      ...
      <h2 className='text-3xl font-semibold'>Emma Watson stands up fo Turkish women</h2>
      ...
      <div>
        <img className='w-[67vw] h-[40vw] object-cover' src="https://images.pexels.com/photos/440320/pexels-photo-440320.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="" />
      </div>
      <div>
